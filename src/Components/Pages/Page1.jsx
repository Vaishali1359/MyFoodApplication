    ...
    <div className="w-full justify-center p-8 bg-[#f9f9f9] self-center mb-20 " >
      ...
      <div className="px-6 md:px-48 mt-10  space-y-10">
        ...
        <ol className="list-decimal pl-5 space-y-3 text-[15px]">
          <li><strong>Quality Mutton :</strong> The heart of a perfect burger is top-notch beet. Opt for fresh, high-quality ground beef with a fat content of about 20% for the juiciest, most flavorful results.</li>
          <li><strong>Don't Overwork the Meat:</strong> A generous pinch of salt and black pepper just before cooking will enhance the beef's natural flavors without overshadowing them.</li>
          <li><strong>Cooking:</strong> When forming your patties, be gentle. Overworking the meat can lead to dense, tough burgers. You want a patty that's firm enough to hold together, but not compressed.</li>
          <li><strong>Resting:</strong> High heat is crucial. Whether you're grilling or pan-searing, make sure your cooking surface is hot enough to form a nice crust on the patty, sealing in those delicious juices.</li>
        ...
        <ol className="list-decimal pl-5 space-y-3 text-[15px]">
          <li><strong>Quality Chiken:</strong> The heart of a perfect burger is top-notch beef. Opt for fresh, high-quality ground beef with a fat content of about 20% for the juiciest, most flavorful results.</li>
          ...
          <li><strong>Presentation tells a story:</strong> Allow your cooked burgers to rest for a few minutes before serving. This lets the juices redistribute throughout the patty, ensuring a moist and flavorful bite.</li>
        </ol>
